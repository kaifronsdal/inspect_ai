...
| F10.2 | scout-only — collapseToolMessages=false path; inspect renders error correctly | [per-finding/F10.2.md](verify/per-finding/F10.2.md) |
| F11.8 | scout-only — same gate; ContentData renders correctly in inspect | [per-finding/F11.8.md](verify/per-finding/F11.8.md) |
